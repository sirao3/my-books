...
namespace my_books.Migrations
{
    ...
    [Migration("20240109035207_RefreshToken")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("my_books.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("my_books.RefreshToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("my_books.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("my_books.RefreshToken", b =>
                {
                    b.HasOne("my_books.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
